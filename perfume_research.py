...
def research_reference(reference, timeout=12):
    ...
    try:
        ...
        if len(raw)>1_000_000:return result
        ...
        if not sources or not summary or not grounding.get('webSearchQueries') or not grounding.get('groundingSupports'):return result
