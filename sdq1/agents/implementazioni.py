...
# L'«abitino» identitario (Codice del Cuore) NON è più iniettato qui dal singolo
# agente: lo applica il LLMRouter a OGNI provider (Anthropic, GPT, Gemini, …) in
# un punto solo — vedi LLMRouter.imposta_abito / _vesti. Così tutte le IA usano
# lo stesso metodo e apprendono l'identità dalla stessa memoria condivisa.
