...
Test locali dopo questa estensione: 43 test complessivi, inclusi i nuovi casi di estrazione, preferenze multiple e immagini simulate. JavaScript: trasmissione delle righe senza cliente/UUID e 72 combinazioni locali. Le prove con risposte simulate non dimostrano disponibilità dei fornitori in produzione.
