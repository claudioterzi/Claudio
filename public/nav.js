...
(function () {
  ...
  var gruppi = [
    ...
    ['Progetto', [['creazioni.html', 'Tutti i progetti'], ['scritti.html', 'Scritti'], ['musica.html', 'Musica'], ['fabbrica.html', 'Fabbrica dei Desideri'], ['opera.html', 'Opera'], ['home.html', 'Agorà']]]
  ];
  ...
  var aliases = {'': 'soglia.html', home: 'home.html', alpha: 'alpha.html', soglia: 'soglia.html',
    viaggi: 'viaggi.html', parti: 'parti.html', flight: 'flight_hunter.html', oracolo: 'oracolo.html', progetti: 'creazioni.html', scritti: 'scritti.html', musica: 'musica.html', fabbrica: 'fabbrica.html'};
  ...
  ingresso.href = base.href;
  ingresso.textContent = 'Home · La Soglia';
  ingresso.setAttribute('aria-label', 'Home: ingresso dalla Soglia');
